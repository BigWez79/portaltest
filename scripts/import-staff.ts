 ...
 *
 * The parsing lives in `scripts/staff-csv.ts` — headers, warnings and what a
 * column means are documented and tested there. This file reads the file,
 * prints what was found and writes it.
 *
...
import { NO_ACTIVE_ADMIN_WARNING, summarise, toRows } from "./staff-csv";
...
async function main() {
  ...
  if (counts.noActiveAdmin) console.warn(`\n${NO_ACTIVE_ADMIN_WARNING}`);
